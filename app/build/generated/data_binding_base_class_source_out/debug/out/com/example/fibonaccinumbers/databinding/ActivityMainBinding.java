...
package com.example.fibonaccinumbers.databinding;
...
import com.example.fibonaccinumbers.R;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull EditText inputField,
      @NonNull Spinner modeSpinner, @NonNull TextView outputText, @NonNull Button toggleButton) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, inputField, modeSpinner,
          outputText, toggleButton);
    }
